...
RUN curl -u admin:nexus "http://192.168.1.19:8081/repository/foyerrouaMnissi/com/example/FoyerRouamnissi/0.0.1-SNAPSHOT/FoyerRouamnissi-0.0.1-20240409.223403-16.jar" --output /app/FoyerRouamnissi-0.0.1-20240409.223403-16.jar
